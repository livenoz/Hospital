...
import { PatientModel } from '../../shared/models/patient/PatientModel';
import { PatientsResponse } from '../../shared/models/patient/PatientsResponse';
...
export class PatientProfilesComponent implements OnInit {
  ...
  private onGetNext = (data: PatientsResponse) => {
